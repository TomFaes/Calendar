...
class TwoFieldTwoHourFourTeamsTest extends TestCase
{
    protected $repo;
    ...
    protected function defaultGeneratedSeasonTests($generatedSeason){
        ...
        $this->assertArrayHasKey('team3', $generatedSeason['stats'][$groupUser]);
        $this->assertArrayHasKey('team4', $generatedSeason['stats'][$groupUser]);
