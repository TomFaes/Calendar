...
<div style="overflow-x:auto; margin-left:4em;">
    ...
    <?php
    /*convert json to an array for this view*/
     $seasonArray = json_decode($seasonJson, TRUE);
    ?>
    <table class="table" >
        <thead>
        <tr>
        ...
        <tr>
            ...
            @foreach($days as $day)
                @if(isset($seasonArray['date'][$day][$user->id]) === true)
                    <td style="text-align: center">{{substr($seasonArray['date'][$day][$user->id], -1)}}</td>
