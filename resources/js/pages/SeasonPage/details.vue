    ...
    <div>
        ...
        <hr>
         <div class="button-row">
            ...
            <button class="btn btn-primary fa" @click.prevent="mailRegisterAbsence()" v-if="season.is_generated == 0 && season.type_member == 'Admin'">Mail to register absences</button>
